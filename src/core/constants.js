...
var SHADOW_BIAS = 0.0008;
var SHADOW_SLOPE_BIAS = 0.005;
var ENABLE_SHADOW_PCF = true;
var SHADOW_TEXEL_SIZE = 0.5; // if an integer, use a string like '1.0'
var SHADOW_PCF_SIZE = 2;
var FOG_DENSITY = 0.0001;
var ATTEN_CONST = 1.0;
